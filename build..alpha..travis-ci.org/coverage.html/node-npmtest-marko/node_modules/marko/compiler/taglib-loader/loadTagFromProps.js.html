...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-marko/node_modules/marko/compiler/taglib-loader/loadTagFromProps.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-marko/node_modules/marko/compiler/taglib-loader/loadTagFromProps.js</span></h1>
    <h2>
        
        Statements: <span class="metric">57.83% <small>(133 / 230)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">44.12% <small>(45 / 102)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">63.41% <small>(26 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">57.83% <small>(133 / 230)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-marko/node_modules/marko/compiler/taglib-loader/</a> &#187; loadTagFromProps.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function exists(path) {</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        markoModules.resolve(path);</span>
...
&nbsp;
        ...
        this.dirname = tag.dir || <span class="branch-1 cbranch-no" title="branch not covered" >tag.dirname;</span>
    }
&nbsp;
    load(tagProps) {
...
<span class="cstat-no" title="statement not covered" >            nestedVariable = {</span>
                name: value
            };
        } else {
            nestedVariable = {};
...
&nbsp;
        ...
        for (i=0; i&lt;parts.length; i++) {
            part = parts[i];
            <span class="missing-if-branch" title="else path not taken" >E</span>if (part.startsWith('@')) {
                hasAttr = true;
&nbsp;
            ...
            } else <span class="cstat-no" title="statement not covered" >if (part.startsWith('&lt;')) {</span>
<span class="cstat-no" title="statement not covered" >                hasNestedTag = true;</span>
            } else {
        ...
        if (value != null &amp;&amp; typeof value === 'object') {
            for (k in value) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (value.hasOwnProperty(k)) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (k.startsWith('@') || k.startsWith('&lt;')) {
...
&nbsp;
                        if (isSupportedProperty(propNameDashes) &amp;&amp;
                            ...
                            attrProps[k] = value[k];
                            delete value[k];
                        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (isSupportedProperty(propNameDashes)) {
                            // Move over all of the properties that are associated with a tag
<span class="cstat-no" title="statement not covered" >                            tagProps[k] = value[k];</span>
<span class="cstat-no" title="statement not covered" >                            delete value[k];</span>
                        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (loaders.isSupportedAttributeProperty(propNameDashes)) {
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!type &amp;&amp; hasAttr &amp;&amp; hasNestedTag) {
                // If we have an attribute and a nested tag then default
                // the attribute type to "expression"
<span class="cstat-no" title="statement not covered" >                attrProps.type = 'expression';</span>
            }
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof value === 'string') {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (hasNestedTag &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >hasAttr)</span> {
<span class="cstat-no" title="statement not covered" >                tagProps = attrProps = {</span>
                    type: value
                };
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (hasNestedTag) {
<span class="cstat-no" title="statement not covered" >                tagProps = {</span>
                    type: value
                };
            } else {
                attrProps = {
...
<span class="cstat-no" title="statement not covered" >                let nestedTag = new types.Tag(this.filePath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                loadTagFromProps(</span>
                    nestedTag,
                    tagProps,
                    dependencyChain.append(part));
&nbsp;
                ...
                // can be repeated
<span class="cstat-no" title="statement not covered" >                var isNestedTagRepeated = false;</span>
<span class="cstat-no" title="statement not covered" >                if (part.endsWith('[]')) {</span>
<span class="cstat-no" title="statement not covered" >                    isNestedTagRepeated = true;</span>
<span class="cstat-no" title="statement not covered" >                    part = part.slice(0, -2);</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                var nestedTagName = part.substring(1, part.length-1);</span>
<span class="cstat-no" title="statement not covered" >                nestedTag.name = nestedTagName;</span>
<span class="cstat-no" title="statement not covered" >                nestedTag.isRepeated = isNestedTagRepeated;</span>
                // Use the name of the attribute as the target property unless
                // this target property was explicitly provided
<span class="cstat-no" title="statement not covered" >                nestedTag.targetProperty = attrProps.targetProperty || nestedTagTargetProperty;</span>
<span class="cstat-no" title="statement not covered" >                tag.addNestedTag(nestedTag);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!nestedTag.isRepeated) {</span>
<span class="cstat-no" title="statement not covered" >                    let attr = loaders.loadAttributeFromProps(</span>
                        nestedTag.targetProperty,
                        { type: 'object' },
                        dependencyChain.append(part));
&nbsp;
<span class="cstat-no" title="statement not covered" >                    tag.addAttribute(attr);</span>
                }
            } else {
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
...
&nbsp;
     ...
     */
    template<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        var tag = this.tag;</span>
...
<span class="cstat-no" title="statement not covered" >        if (!exists(path)) {</span>
...
&nbsp;
     ...
     * }
     */
    var<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        this._handleVar(value, this.dependencyChain.append('var'));</span>
    }
    /**
     ...
     */
    bodyFunction<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        var tag = this.tag;</span>
<span class="cstat-no" title="statement not covered" >        var parts = bodyFunctionRegExp.exec(value);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var functionName = parts[1];</span>
<span class="cstat-no" title="statement not covered" >        var params = parts[2];</span>
<span class="cstat-no" title="statement not covered" >        if (params) {</span>
<span class="cstat-no" title="statement not covered" >            params = params.trim().split(/\s*,\s*/);</span>
<span class="cstat-no" title="statement not covered" >            for (var i=0; i&lt;params.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                if (params[i].length === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    throw new Error('Invalid parameters for body-function with value of "' + value + '"');</span>
                } else <span class="cstat-no" title="statement not covered" >if (!safeVarName.test(params[i])) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        tag.setBodyFunction(functionName, params);</span>
    }
    /**
     ...
     * }
     */
    importVar<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        var tag = this.tag;</span>
<span class="cstat-no" title="statement not covered" >        forEachEntry(value, (varName, varValue) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            var importedVar = {</span>
                targetProperty: varName
            };
&nbsp;
<span class="cstat-no" title="statement not covered" >            var expression = varValue;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                expression = varName;</span>
            ...
            else <span class="cstat-no" title="statement not covered" >if (typeof expression === 'object') {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            importedVar.expression = markoCompiler.builder.parseExpression(expression);</span>
<span class="cstat-no" title="statement not covered" >            tag.addImportedVariable(importedVar);</span>
        });
    }
    /**
     * The tag type.
     */
    type<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        var tag = this.tag;</span>
<span class="cstat-no" title="statement not covered" >        tag.type = value;</span>
    }
    /**
     ...
     * }
     */
    nestedTags<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        var filePath = this.filePath;</span>
<span class="cstat-no" title="statement not covered" >        var tag = this.tag;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        forEachEntry(value, (nestedTagName, nestedTagDef) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            var dependencyChain = this.dependencyChain.append(`nestedTags["${nestedTagName}]`);</span>
<span class="cstat-no" title="statement not covered" >            var nestedTag = new types.Tag(filePath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            loadTagFromProps(</span>
                nestedTag,
                nestedTagDef,
...
&nbsp;
     ...
     * content is parsed.
     */
    body<span class="fstat-no" title="function not covered" >(value) {</span>
...
&nbsp;
    parseAttributes<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        this.tag.parseAttributes = value;</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw createError('Unable to load tag (' + dependencyChain + '): ' + err, err);</span>
    }
&nbsp;
    return tag;
}
